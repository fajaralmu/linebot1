...
@Slf4j
@LineMessageHandler
public class MySimpleLineBotController {
    @Autowired
    ...
    public MySimpleLineBotController() {
    	log.info("------- MySimpleLineBotController -------------");
    	System.out.println("------- MySimpleLineBotController -------------");
    }
    
    @EventMapping
    public void handleTextMessageEvent(MessageEvent<TextMessageContent> event) throws Exception {
    	System.out.println(":::::: handleTextMessageEvent >>>>"+ event.getMessage());
    ...
    public void handleStickerMessageEvent(MessageEvent<StickerMessageContent> event) {
    	System.out.println(":::::: handleStickerMessageEvent >>>>"+ event.getMessage());
        handleSticker(event.getReplyToken(), event.getMessage());
    }

    @EventMapping
    public void handleLocationMessageEvent(MessageEvent<LocationMessageContent> event) {
    	System.out.println(":::::: handleLocationMessageEvent >>>>"+ event.getMessage());
    ...
    public void handleImageMessageEvent(MessageEvent<ImageMessageContent> event) throws IOException {
    	System.out.println(":::::: handleImageMessageEvent >>>>"+ event.getMessage());
    ...
    public void handleAudioMessageEvent(MessageEvent<AudioMessageContent> event) throws IOException {
    	System.out.println(":::::: handleAudioMessageEvent >>>>"+ event.getMessage());
    ...
    public void handleFileMessageEvent(MessageEvent<FileMessageContent> event) {
    	System.out.println(":::::: handleFileMessageEvent >>>>"+ event.getMessage());
    ...
    private static DownloadedContent createTempFile(String ext) {
        ...
        Path tempFile = MySimpleLineBot.downloadedContentDir.resolve(fileName);
